...
<img width="1030" height="600" alt="intro" src="https://github.com/user-attachments/assets/b7aca484-5ee7-4bba-a6f8-655b5ba340ea" />
...
# 분류 예측 프로세스
<img width="1920" height="1080" alt="classifier_flow" src="https://github.com/user-attachments/assets/e4c4d7c4-bbca-4103-ba2d-fe1c10f9b58f" />
...
- ※ 과적합이란, 학습 데이터를 과하게 학습시켜서 실제 데이터에서는 오차가 오히려 증가하는 현상이다.
...
전세계 인구 중 10%의 사람들이 질병 A를 앓는다고 가정한다.
  ...
  <img width="261" height="61" alt="bayesian_inference01" src="https://github.com/user-attachments/assets/e919144b-d4e1-476f-8538-2c4cebf34722" />

<img width="309" height="31" alt="bayesian_inference02" src="https://github.com/user-attachments/assets/12e13d2e-8b3e-4b35-a285-a0852be4679b" />

<img width="475" height="85" alt="bayesian_inference03" src="https://github.com/user-attachments/assets/a746edd1-2021-4315-b173-2f8d722837e8" />
        
<img width="384" height="87" alt="bayesian_inference04" src="https://github.com/user-attachments/assets/5d605fd4-891c-493d-93bf-e8a373aba62c" />


> 🚩결과: 약 30.8%
<img width="284" height="42" alt="bayesian_inference05" src="https://github.com/user-attachments/assets/ed1294d4-cdca-46f6-b670-aff2e03484eb" />
...
유사도 분석은 **두 개의 문장, 단어, 문서 등이 얼마나 비슷한지**를 수치로 표현하는 분석 기법이다.  
자연어 처리(NLP)에서 가장 많이 사용되며, 추천 시스템·검색 엔진·문장 분류 등에 활용된다.


# 📌 1. 유사도 분석이란?

- 두 데이터(문장, 단어, 문서 등)의 **유사한 정도**를 숫자로 표현  
- 보통 **0~1 사이**의 값  
  - 1에 가까울수록 매우 유사  
  - 0은 전혀 유사하지 않음  
...
| 문장 A | 문장 B | 유사도 |
|--------|--------|---------|
| "나는 오늘 기분이 좋다" | "오늘은 행복한 하루다" | 0.82 |
| "비가 온다" | "나는 밥을 먹는다" | 0.02 |


# 📌 2. 유사도 계산 방식

유사도 분석에서 가장 중요한 것은 **문장을 숫자로 바꾸는 방법(벡터화)** + **벡터 간 거리 계산 방식**이다.
